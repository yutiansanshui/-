<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"D:\www\mvc\code\public/../application/admin\view\goods\edit.html";i:1529830300;s:50:"D:\www\mvc\code\application\admin\view\layout.html";i:1529830216;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <form action="<?php echo url('update'); ?>" method="post" id="tab" enctype="multipart/form-data">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade in" id="desc">
                    <div class="well">
                        <label>商品简介：</label>
                        <textarea id="editor" name="goods_introduce" class="input-xlarge" style="width:1000px;height: 500px;"><?php echo $info['goods_introduce']; ?></textarea>
                    </div>
                </div>
                <div class="tab-pane fade in" id="attr">
                    <div class="well">
                        ...
                        <select name="type_id" class="input-xlarge">
                            ...
                            <option value="<?php echo $v['id']; ?>" <?php if(($v['id'] == $info['type_id'])): ?>selected="selected"<?php endif; ?>><?php echo $v['type_name']; ?></option>
                            <?php endforeach; ?>
                        </select>
                        <div id="attrs">
                            <!--<label>商品品牌：</label>-->
                ...
                <div class="tab-pane fade in" id="pics">
                    <div class="well">
                        ...
                        <div>
                            <img src="<?php echo $v['pics_sma']; ?>" style="width:100px;">[<a class="delpics" pics_id="<?php echo $v['id']; ?>" href="javascript:;">-</a>]
                        </div>
                        <?php endforeach; ?>
                    </div>
                    <div class="well">
