<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"D:\www\mvc\code\public/../application/home\view\goods\detail.html";i:1529830235;s:49:"D:\www\mvc\code\application\home\view\layout.html";i:1529830235;}*/ ?>
<!DOCTYPE html>
<html>
...
<script type="text/javascript">
	...
	$(function(){
		...
		$('#specification').find('a').click(function(){
			//判断，如果有locked这个class名称，不做任何处理
			if( $(this).hasClass('locked') ) return;
			//否则 继续处理
			//对当前行的a标签，移除selected这个class名
			$(this).closest('dl').find('a').removeClass('selected');
			//给点击的当前a标签，加上selected这个class
		...
		$('#addshopcar').click(function(){
			...
			//从页面获取选中的属性值，取主键id值拼接成字符串，放到隐藏表单中
